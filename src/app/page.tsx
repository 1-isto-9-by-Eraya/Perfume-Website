      ...
      <SmoothScrollProvider>
        <section id="landing" className="relative text-[#fffff2] bg-black">
          ...
          >
            ...
            <div className="absolute top-0 md:-top-10 h-[100vh] left-0 w-full z-0 overflow-hidden pointer-events-none">
              {/* Background image */}
              <img
                src="/images/section1-bg.png"
                alt=""
                className="absolute inset-0 w-full h-full md:h-full object-cover select-none opacity-40 z-0"
                loading="eager"
                decoding="async"
                fetchPriority="high"
                draggable={false}
              ...
              <img
                src="/images/E.png"
                alt="sdfghj"
                className="absolute -left-6 top-10 inset-0 w-[100%] lg:w-[40%] sm:h-[50%] md:h-[70%] lg:h-full object-fit select-none z-10 opacity-60"
                loading="eager"
                decoding="async"
                fetchPriority="high"
                draggable={false}
            ...
            <div className="absolute top-0 left-0 w-full z-20">
              ...
              <section className="h-screen -mt-24 flex flex-col items-center justify-center px-6 text-center">
                ...
                >
                  ...
                  <span
                    className={`${monsieurLaDoulaise.className} text-[29px] md:text-[34px]`}
                  >
                    {" "}
                    Achievers
                  </span>
              ...
              <section className="h-screen bg-transparent grid lg:grid-cols-2 items-center px-6 lg:px-16 gap-10 mt-32">
                <div className="p-8 rounded-lg backdrop-blur-sm max-w-xl">
                  ...
                  >
                    Scent With Intention, Our Identity
                  </h2>
                  ...
                  >
                    ...
                    elegance that doesn't fade with trends. Each 1:9 creation is
                    a study in balance — where minimalism meets richness, and
                    where essence always outweighs appearance
                  </p>
                  <div className="flex flex-col gap-4">
                    <button
                      onClick={() => router.push("/our-story")}
                      className={`mt-8 inline-flex items-center justify-center px-8 py-3 w-1/2
                        border border-white/80 bg-transparent text-white
                        ${inter.className} font-semibold text-[14px] md:text-[16px] tracking-wide uppercase
                        transition-colors duration-200 cursor-pointer opacity-0 animate-fadeInDelayLong
